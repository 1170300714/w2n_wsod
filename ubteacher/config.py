...
def add_ubteacher_config(cfg):
    ...
    _C.DATASETS.TRAIN_CLS = ()
    _C.DATASETS.TRAIN_REG = ()
    ...
    _C.DATALOADER.RANDOM_DATA_SEED_PATH_MEDIUM = ""
    _C.DATALOADER.RANDOM_DATA_SEED_PATH_CLS = ""
    _C.DATALOADER.RANDOM_DATA_SEED_PATH_REG = ""
